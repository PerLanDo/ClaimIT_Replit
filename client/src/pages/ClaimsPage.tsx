...
const mockMyClaims: (Claim & { itemTitle: string })[] = [
  {
    ...
    claimantId: "1",
    proofDescription:
      "This is my phone. It has a crack on the bottom left corner and my name is engraved on the back case.",
    proofImageUrl: null,
    status: "pending",
    dateFiled: new Date("2024-12-11T10:00:00"),
    reviewedBy: null,
    reviewNotes: null,
    handoverQrCode: null,
  },
  {
    ...
    claimantId: "1",
    proofDescription:
      "This is my charger for my MacBook Pro. I can show you my laptop that matches.",
    proofImageUrl: null,
    status: "approved",
    dateFiled: new Date("2024-12-09T14:00:00"),
    reviewedBy: null,
    reviewNotes: null,
    handoverQrCode: null,
  },
...
const mockReceivedClaims: (Claim & { itemTitle: string })[] = [
  {
    ...
    claimantId: "8",
    proofDescription:
      "These are my car keys. The red keychain has my initials RS on it. The key is for a Honda Civic 2020.",
    proofImageUrl: null,
    status: "pending",
    dateFiled: new Date("2024-12-10T09:00:00"),
    reviewedBy: null,
    reviewNotes: null,
    handoverQrCode: null,
  },
          ...
          {mockReceivedClaims.length === 0 ? (
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p className="text-sm mt-1">
                Claims for your found items will appear here
              </p>
            </div>
          ) : (
